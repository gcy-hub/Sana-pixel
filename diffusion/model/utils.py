...
def auto_grad_checkpoint(module, *args, **kwargs):
    if getattr(module, "grad_checkpointing", False):
        ...
        if isinstance(module, Iterable):
            ...
            # Non-reentrant checkpointing also computes parameter gradients
            # when the module input itself (for example noisy RGB) does not
            # require gradients.  This is required by the pixel detailer's
            # first encoder stage and is the PyTorch-recommended variant.
            return checkpoint(module, *args, use_reentrant=False, **kwargs)
